...
describe "User pages" do
  ...
  describe "index" do
    ...
    describe "pagination" do
      ...
      it "should list each user" do
        User.page(1).order('name ASC').each do |user|
  ...
  describe "signup" do
    ...
    describe "with valid information" do
      ...
      describe "after saving the user" do
        ...
        it { should have_selector('div.alert.alert-success', text: 'Thanks for signing up!') }
  ...
  describe "edit" do
    ...
    describe "page" do
      ...
      it { should have_link('avatar_change_link',
